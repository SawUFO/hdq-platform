...
.chart-card-body { padding:12px 16px 14px; border-top:1px solid var(--n100); margin-top:auto; }
...
export async function renderCharts(env, params, authed = true) {
...
<div class="charts-pagination">
  ...
  // Locked overlay for guests — shown over the chart gallery frame
...
${membershipFooterBand()}`;
  ...
  return htmlResponse(pageShell(body, {
    ...
    extraStyle: CHARTS_CSS + lockedOverlayCSS,

...
(function(){
  ...
  svg.appendChild(el("text", {x:xS(lastMa.i)-candleW/2-4, y:yp(lastMa.v)+20, "text-anchor":"end", "font-size":"7.5", fill:"#888888", "font-family":"-apple-system,BlinkMacSystemFont,Roboto,Helvetica,Arial,sans-serif"}, "5D MA"));
